...
class ProductProcessDetailTransformer extends Detail
{
    ...
    protected function getData(Model $model)
    {
        return [
            ...
            'configurable' => (bool) $model->configurable,
            'use_ratio' => (bool) $model->use_ratio,
            'use_ratiouse_ratio' => $model->use_ratiouse_ratio,
            ...
            'insheet_default' => (float) $model->insheet_default,
